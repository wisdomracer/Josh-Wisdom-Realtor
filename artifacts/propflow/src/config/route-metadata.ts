...
const images = {
  ...
  woodlandsLuxury: locationPhotos.woodlandsLuxury,
  ...
  shenandoah: locationPhotos.shenandoah,
...
const routeCopy = {
  ...
  "/the-woodlands-luxury-homes": ["The Woodlands Luxury Homes | Josh Wisdom Realtor", "Luxury listing and buyer guidance for The Woodlands estates, custom homes, golf-course properties, and premium neighborhoods.", "woodlandsLuxury"],
  ...
  "/shenandoah-realtor": ["Shenandoah Realtor | Josh Wisdom Realtor", "Josh Wisdom Realtor helps Shenandoah TX buyers and sellers with local guidance, home valuation, and north Houston market insight.", "shenandoah"],
