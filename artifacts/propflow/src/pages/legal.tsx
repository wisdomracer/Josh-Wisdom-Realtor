  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://thewoodlandslistingagent.com/privacy-policy" />
      </Helmet>
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto max-w-3xl px-4 md:px-6">
          ...
          <p className="mt-5 leading-8 text-neutral-700">Form submissions may include your name, email, phone number, property address, area of interest, and message. You can request that your information be updated or deleted by contacting WisdomRacer@gmail.com.</p>
        </div>
      </section>
    </>
  );
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://thewoodlandslistingagent.com/terms" />
      </Helmet>
      <section className="bg-white py-16 md:py-24">
        <div className="container mx-auto max-w-3xl px-4 md:px-6">
          ...
          <p className="mt-5 leading-8 text-neutral-700">Josh Wisdom is affiliated with VIP Realty, 5100 Westheimer Ste 200, Houston, TX 77027. Equal Housing Opportunity.</p>
          <div className="mt-8 space-y-3">
            <a className="block font-semibold text-amber-700" href="https://www.trec.texas.gov/forms/consumer-protection-notice">TREC Consumer Protection Notice</a>
            <a className="block font-semibold text-amber-700" href="https://www.trec.texas.gov/forms/information-about-brokerage-services">TREC Information About Brokerage Services</a>
          </div>
        </div>
      </section>
    </>
