...
const buyerPhoto = locationPhotos.woodlands;
    ...
    <>
      ...
      <section className="relative min-h-[690px] overflow-hidden bg-[#050505] text-white">
        <div className="absolute inset-0 lg:left-[45%]">
          <ResponsiveLocationImage photo={buyerPhoto} className="h-full w-full object-cover" sizes="(min-width: 1024px) 55vw, 100vw" loading="eager" fetchPriority="high" />
        </div>
